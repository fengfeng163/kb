...
- You can create a GlideDateTime object from a GlideDate object by passing in the GlideDate object as an argument to the GlideDateTime constructor

![[Pasted image 20260818202229.png]]
...
Note: Methods can use the Java Virtual Machine time zone, so use equivalent local time and UTC methods whenever possible to prevent unexpected results.

### GlideSystem method documentation 
![[Pasted image 20260818202335.png]]

https://developer.servicenow.com > Reference > APIs > Server Scoped (or Server Global) > GlideSystem (in list filter)
...
4. Enter GlideSystem in the list filter.
